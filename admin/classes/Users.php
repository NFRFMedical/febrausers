...
class Users{
  ...
  public function checkExistEmail($email){
    ...
    // Check Exist userID Address Method
  ...
  public function userRegistration($data){
    ...
    $results=mysqli_query($cone,$sqll);
    $rows=mysqli_fetch_array($results);
    $count= str_pad($rows[0], 4, '0', STR_PAD_LEFT); 
    $mask = "FDS-";
    $assignedID = $mask.$count;
    mysqli_close($cone);
...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
        return $msg;
    }elseif ($checkExistUserId == TRUE) {
      $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
<strong>Error !</strong> Unknown Error , please try Signing Up Again... !</div>';
        return $msg;
    }
    else{
